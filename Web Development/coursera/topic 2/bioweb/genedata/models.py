...
class Sequencing(models.Model):
    sequencing_factory = models.CharField(
...
class Gene(models.Model):
    ...
    # CREATE TABLE Gene(gene_id VARCHAR(256) NOT NULL, entity VARCHAR(256) NOT NULL, start INT NOT NULL, stop INT NOT NULL, sense CHAR, start_codon CHAR DEFAULT 'M');
